...
namespace RgiSequenceFinder
{
    ...
    ///
    /// VS16 は無視してもよさそう(VS16 の有無を弁別したところで対してメリット少なそう)なので、これで文字が 3300 未満に収まる。
    ///
    /// skin tone 付きの RGI 絵文字シーケンス判定は「tone なし絵文字判定 + tone からのオフセット計算」で処理する。
    ...
    public readonly ref struct EmojiString
    {
        ...
        public static int GetHashCode(ReadOnlySpan<char> utf16)
        {
            ...
            return new EmojiString(buffer.Slice(0, written)).GetHashCode();
        }
